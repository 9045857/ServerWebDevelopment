    ...
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                //var printerProducts = new[]
                //{
                //    new Product("HP Color LaserJet Pro M254dw", 1111),
                //    new Product("Samsung Xpress M2020", 2222),
                //    new Product("Brother HL-L2340DWR", 3333),
                //    new Product("Canon i-SENSYS LBP7018C", 4444),
                //    new Product("Canon i-SENSYS LBP7110Cw", 5555)
                //};

                //foreach (var printer in printerProducts)
                //{
                //    var sqlInsertProduct = "INSERT INTO dbo.Product(Name, Price, CategoryId) " +
                //                           $"VALUES(N'{printer.Name}', CAST({printer.Price} AS Decimal(18, 2)),{categoryId})";
